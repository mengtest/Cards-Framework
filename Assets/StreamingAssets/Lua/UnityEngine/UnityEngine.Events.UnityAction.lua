...
--- 属性:MethodInfo
--- </summary>
UnityAction.Method=nil
--- <summary>
--- 属性:Object
--- </summary>
UnityAction.Target=nil
--- <summary>
--- C#声明:Void Invoke()
--- </summary>
--- <returns>System.Void</returns>
function UnityAction:Invoke()
end
--- <summary>
...
function UnityAction:BeginInvoke(arg_callback,arg_object)
end
--- <summary>
...
--- <returns>System.Void</returns>
function UnityAction:EndInvoke(arg_result)
end
--- <summary>
...
--- <returns>System.Void</returns>
function UnityAction:GetObjectData(arg_info,arg_context)
end
--- <summary>
...
function UnityAction:Equals(arg_obj)
end
--- <summary>
--- C#声明:System.Delegate[] GetInvocationList()
--- </summary>
--- <returns>System.Delegate[]</returns>
function UnityAction:GetInvocationList()
end
--- <summary>
--- C#声明:Int32 GetHashCode()
--- </summary>
--- <returns>System.Int32</returns>
function UnityAction:GetHashCode()
end
--- <summary>
...
function UnityAction:DynamicInvoke(arg_args)
end
--- <summary>
--- C#声明:System.Reflection.MethodInfo get_Method()
--- </summary>
--- <returns>System.Reflection.MethodInfo</returns>
function UnityAction:get_Method()
end
--- <summary>
--- C#声明:System.Object get_Target()
--- </summary>
--- <returns>System.Object</returns>
function UnityAction:get_Target()
end
--- <summary>
--- C#声明:System.Object Clone()
--- </summary>
--- <returns>System.Object</returns>
function UnityAction:Clone()
end
--- <summary>
--- C#声明:System.String ToString()
--- </summary>
--- <returns>System.String</returns>
function UnityAction:ToString()
end
--- <summary>
--- C#声明:System.Type GetType()
--- </summary>
--- <returns>System.Type</returns>
function UnityAction:GetType()
end

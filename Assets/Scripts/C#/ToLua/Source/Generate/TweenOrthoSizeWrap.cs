...
public class TweenOrthoSizeWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(TweenOrthoSize), typeof(UITweener));
	...
	static int Begin(IntPtr L)
	{
		try
		{
			...
			TweenOrthoSize o = TweenOrthoSize.Begin(arg0, arg1, arg2);
			ToLua.Push(L, o);
			return 1;
		}
		catch(Exception e)
	...
	static int SetStartToCurrentValue(IntPtr L)
	{
		try
		{
			...
			TweenOrthoSize obj = (TweenOrthoSize)ToLua.CheckObject(L, 1, typeof(TweenOrthoSize));
	...
	static int get_from(IntPtr L)
	{
		...
		try
		{
			...
			TweenOrthoSize obj = (TweenOrthoSize)o;
			float ret = obj.from;

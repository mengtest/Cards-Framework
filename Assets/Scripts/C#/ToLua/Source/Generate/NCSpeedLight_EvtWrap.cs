...
public class NCSpeedLight_EvtWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(NCSpeedLight.Evt), typeof(System.Object));
		L.RegFunction("New", _CreateNCSpeedLight_Evt);
	...
	static int _CreateNCSpeedLight_Evt(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				NCSpeedLight.Evt obj = new NCSpeedLight.Evt();
			...
			else if (count == 1 && TypeChecker.CheckTypes(L, 1, typeof(int)))
			{
				...
				NCSpeedLight.Evt obj = new NCSpeedLight.Evt(arg0);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(int), typeof(object), typeof(byte[])))
			{
				...
				NCSpeedLight.Evt obj = new NCSpeedLight.Evt(arg0, arg1, arg2);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: NCSpeedLight.Evt.New");
			}
		}
		catch(Exception e)
		{
	...
	static int get_ID(IntPtr L)
	{
		...
		try
		{
			...
			NCSpeedLight.Evt obj = (NCSpeedLight.Evt)o;
			int ret = obj.ID;

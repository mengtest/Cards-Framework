...
public class NCSpeedLight_ByteBufferWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(NCSpeedLight.ByteBuffer), typeof(System.Object));
		...
		L.RegFunction("New", _CreateNCSpeedLight_ByteBuffer);
		L.RegFunction("__tostring", ToLua.op_ToString);
		L.EndClass();
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateNCSpeedLight_ByteBuffer(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				NCSpeedLight.ByteBuffer obj = new NCSpeedLight.ByteBuffer();
			...
			else if (count == 1 && TypeChecker.CheckTypes(L, 1, typeof(byte[])))
			{
				...
				NCSpeedLight.ByteBuffer obj = new NCSpeedLight.ByteBuffer(arg0);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: NCSpeedLight.ByteBuffer.New");
			}
		}
		catch(Exception e)
		{
	...
	static int Close(IntPtr L)
	{
		try
		{
			...
			NCSpeedLight.ByteBuffer obj = (NCSpeedLight.ByteBuffer)ToLua.CheckObject(L, 1, typeof(NCSpeedLight.ByteBuffer));
			obj.Close();
			return 0;
		}
		catch(Exception e)

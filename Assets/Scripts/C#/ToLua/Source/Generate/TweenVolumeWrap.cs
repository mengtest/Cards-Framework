...
public class TweenVolumeWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(TweenVolume), typeof(UITweener));
	...
	static int Begin(IntPtr L)
	{
		try
		{
			...
			TweenVolume o = TweenVolume.Begin(arg0, arg1, arg2);
			ToLua.Push(L, o);
			return 1;
		}
		catch(Exception e)
	...
	static int SetStartToCurrentValue(IntPtr L)
	{
		try
		{
			...
			TweenVolume obj = (TweenVolume)ToLua.CheckObject(L, 1, typeof(TweenVolume));

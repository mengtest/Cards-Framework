...
public class NCSpeedLight_ResManagerWrap
{
	...
	static int GetStreamingAssetsURL(IntPtr L)
	{
		try
		{
			...
			string o = NCSpeedLight.ResManager.GetStreamingAssetsURL();
	...
	static int GetStreamingAssetsPath(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 0);
			string o = NCSpeedLight.ResManager.GetStreamingAssetsPath();
			LuaDLL.lua_pushstring(L, o);
			return 1;
		}
		catch(Exception e)
	...
	static int AssemblyAssetBundle(IntPtr L)
	{
		try
		{
			...
			string arg1 = null;
			NCSpeedLight.LoadedAssetBundle o = NCSpeedLight.ResManager.AssemblyAssetBundle(arg0, out arg1);
	...
	static int GetLoadedAssetBundle(IntPtr L)
	{
		try
		{
			...
			string arg0 = ToLua.CheckString(L, 1);
			string arg1 = null;
			NCSpeedLight.LoadedAssetBundle o = NCSpeedLight.ResManager.GetLoadedAssetBundle(arg0, out arg1);
			ToLua.PushObject(L, o);
			LuaDLL.lua_pushstring(L, arg1);
			return 2;
		}
	...
	static int UnloadAssetBundle(IntPtr L)
	{
		try
		{
			...
			string arg0 = ToLua.CheckString(L, 1);
			NCSpeedLight.ResManager.UnloadAssetBundle(arg0);
			return 0;
		}
		catch(Exception e)
		{
	...
	static int LoadAssetAsync(IntPtr L)
	{
		try
		{
			...
			{
				 arg2 = (NCSpeedLight.LoadAssetCallback)ToLua.CheckObject(L, 3, typeof(NCSpeedLight.LoadAssetCallback));
			}
			else
			{
	...
	static int LoadLevelAsync(IntPtr L)
	{
		try
		{
			...
			NCSpeedLight.LoadOperation o = NCSpeedLight.ResManager.LoadLevelAsync(arg0, arg1, arg2);
			ToLua.Push(L, o);
			return 1;
		}
		catch(Exception e)
	...
	static int IsInProgress(IntPtr L)
	{
		try
		{
			...
			string arg0 = ToLua.CheckString(L, 1);
			string arg1 = ToLua.CheckString(L, 2);
			NCSpeedLight.LoadAssetOperation o = NCSpeedLight.ResManager.IsInProgress(arg0, arg1);
			ToLua.Push(L, o);
			return 1;
		}
		catch(Exception e)
	...
	static int get_IsResourceMode(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushboolean(L, NCSpeedLight.ResManager.IsResourceMode);
			return 1;
		}
		catch(Exception e)
		{
	...
	static int get_IsCompressedBundle(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushboolean(L, NCSpeedLight.ResManager.IsCompressedBundle);
			return 1;
		}
		catch(Exception e)
		{

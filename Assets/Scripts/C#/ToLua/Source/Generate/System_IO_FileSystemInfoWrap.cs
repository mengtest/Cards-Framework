...
public class System_IO_FileSystemInfoWrap
{
	...
	static int GetObjectData(IntPtr L)
	{
		try
		{
			...
			System.IO.FileSystemInfo obj = (System.IO.FileSystemInfo)ToLua.CheckObject(L, 1, typeof(System.IO.FileSystemInfo));
	...
	static int get_Extension(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index Extension on a nil value" : e.Message);
		}
	}
	...
	static int get_CreationTime(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index CreationTime on a nil value" : e.Message);
		}
	}
	...
	static int get_CreationTimeUtc(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index CreationTimeUtc on a nil value" : e.Message);
		}
	}
	...
	static int get_LastAccessTime(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index LastAccessTime on a nil value" : e.Message);
		}
	}
	...
	static int get_LastAccessTimeUtc(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index LastAccessTimeUtc on a nil value" : e.Message);
		}
	}
	...
	static int get_LastWriteTime(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index LastWriteTime on a nil value" : e.Message);
		}
	}
	...
	static int get_LastWriteTimeUtc(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index LastWriteTimeUtc on a nil value" : e.Message);
		}
	}

...
public class TypewriterEffectWrap
{
	...
	static int get_delayOnPeriod(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index delayOnPeriod on a nil value" : e.Message);
		}
	}
	...
	static int get_delayOnNewLine(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index delayOnNewLine on a nil value" : e.Message);
		}
	}
	...
	static int get_keepFullDimensions(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index keepFullDimensions on a nil value" : e.Message);
		}
	}
	...
	static int set_current(IntPtr L)
	{
		try
		{
			TypewriterEffect arg0 = (TypewriterEffect)ToLua.CheckUnityObject(L, 2, typeof(TypewriterEffect));

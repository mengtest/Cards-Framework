...
public class NCSpeedLight_UIManager_StandardDialogOptionWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(NCSpeedLight.UIManager.StandardDialogOption), typeof(System.Object));
		L.RegFunction("New", _CreateNCSpeedLight_UIManager_StandardDialogOption);
	...
	static int _CreateNCSpeedLight_UIManager_StandardDialogOption(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				NCSpeedLight.UIManager.StandardDialogOption obj = new NCSpeedLight.UIManager.StandardDialogOption();
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: NCSpeedLight.UIManager.StandardDialogOption.New");
			}
		}
		catch(Exception e)
		{
	...
	static int get_Title(IntPtr L)
	{
		...
		try
		{
			...
			NCSpeedLight.UIManager.StandardDialogOption obj = (NCSpeedLight.UIManager.StandardDialogOption)o;

...
function MaJiangScene.AddPlayer(ui, player)
	if MaJiangScene.Instance.Players[ui] == nil then
		MaJiangScene.Instance.Players[ui] = player;
	end
end
...
function MaJiangScene.InitPlayerData(data)
end

function MaJiangScene.CreatePlayer()
end

-- 根据角标的位置获取玩家对象 
function MaJiangScene.GetPlayerByUIPosition(pos)
...
-- 根据真实位置获取玩家对象
function MaJiangScene.GetPlayerByPosition(pos)
	for key, value in pairs(MaJiangScene.Instance.Players) do
...
-- 根据ID获取玩家对象
function MaJiangScene.GetPlayerByID(id)
	for key, value in pairs(MaJiangScene.Instance.Players) do

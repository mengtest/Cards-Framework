                ...
                if (m_WaitingOperations.Count > 0)
                {
                    ...
                    catch (Exception e)
                    {
                        ...
                        if (loadAssetOperation != null)
                        {
                            ...
                            {
                                Helper.LogError(Helper.Format("Looper success,but some exception occuried, Task key: {0}, Exception: {1}, Track: {2}", loadAssetOperation.AssetPath, e.Message, e.StackTrace));
                            }
                            else
                            {
                                Helper.LogError(Helper.Format("Looper success,but some exception occuried, Exception: {0}, Track: {1}", e.Message, e.StackTrace));
                            }
                        }
                    }
                }

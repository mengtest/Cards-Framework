...
public class NCSpeedLight_UIManagerWrap
{
	...
	static int OpenDialog(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			string arg0 = ToLua.CheckString(L, 1);
			UnityEngine.GameObject o = NCSpeedLight.UIManager.OpenDialog(arg0);
			ToLua.Push(L, o);
			return 1;
		}
		catch(Exception e)
	...
	static int CloseDialog(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			string arg0 = ToLua.CheckString(L, 1);
			NCSpeedLight.UIManager.CloseDialog(arg0);
			return 0;
		}
		catch(Exception e)
		{
	...
	static int OpenStandardDialog(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			NCSpeedLight.UIManager.StandardDialogOption arg0 = (NCSpeedLight.UIManager.StandardDialogOption)ToLua.CheckObject(L, 1, typeof(NCSpeedLight.UIManager.StandardDialogOption));
			NCSpeedLight.UIManager.OpenStandardDialog(arg0);
			return 0;
		}
		catch(Exception e)
		{
	...
	static int OpenProgressDialog(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			NCSpeedLight.UIManager.ProgressDialogOption arg0 = (NCSpeedLight.UIManager.ProgressDialogOption)ToLua.CheckObject(L, 1, typeof(NCSpeedLight.UIManager.ProgressDialogOption));
			NCSpeedLight.UIManager.OpenProgressDialog(arg0);
			return 0;
		}
		catch(Exception e)
		{
	...
	static int OpenTipsDialog(IntPtr L)
	{
		try
		{
			...
			if (count == 1 && TypeChecker.CheckTypes(L, 1, typeof(string)))
			{
				...
				UnityEngine.GameObject o = NCSpeedLight.UIManager.OpenTipsDialog(arg0);
				ToLua.Push(L, o);
				return 1;
			}
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(string), typeof(float)))
			{
				...
				UnityEngine.GameObject o = NCSpeedLight.UIManager.OpenTipsDialog(arg0, arg1);
				ToLua.Push(L, o);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: NCSpeedLight.UIManager.OpenTipsDialog");
			}
		}
		catch(Exception e)
		{
	...
	static int GetWindow(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			string arg0 = ToLua.CheckString(L, 1);
			UnityEngine.GameObject o = NCSpeedLight.UIManager.GetWindow(arg0);
			ToLua.Push(L, o);
			return 1;
		}
		catch(Exception e)
	...
	static int GetDialog(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			string arg0 = ToLua.CheckString(L, 1);
			UnityEngine.GameObject o = NCSpeedLight.UIManager.GetDialog(arg0);
			ToLua.Push(L, o);
			return 1;
		}
		catch(Exception e)

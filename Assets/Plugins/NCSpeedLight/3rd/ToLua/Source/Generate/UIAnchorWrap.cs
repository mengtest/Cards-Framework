...
public class UIAnchorWrap
{
	...
	static int get_side(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index side on a nil value" : e.Message);
		}
	}
	...
	static int get_relativeOffset(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index relativeOffset on a nil value" : e.Message);
		}
	}

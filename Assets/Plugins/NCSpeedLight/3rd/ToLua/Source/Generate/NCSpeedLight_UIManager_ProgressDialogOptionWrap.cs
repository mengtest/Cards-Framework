...
public class NCSpeedLight_UIManager_ProgressDialogOptionWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(NCSpeedLight.UIManager.ProgressDialogOption), typeof(System.Object));
		L.RegFunction("New", _CreateNCSpeedLight_UIManager_ProgressDialogOption);
	...
	static int _CreateNCSpeedLight_UIManager_ProgressDialogOption(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				NCSpeedLight.UIManager.ProgressDialogOption obj = new NCSpeedLight.UIManager.ProgressDialogOption();
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: NCSpeedLight.UIManager.ProgressDialogOption.New");
			}
		}
		catch(Exception e)
		{
	...
	static int get_AutoClose(IntPtr L)
	{
		...
		try
		{
			...
			NCSpeedLight.UIManager.ProgressDialogOption obj = (NCSpeedLight.UIManager.ProgressDialogOption)o;

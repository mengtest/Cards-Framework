...
set projectPath=C:\NCMJ(Android)\Assets\Scripts\protobuf
copy PBMessage.dll %projectPath%\PBMessage.dll
copy PBMessageSerializer.dll %projectPath%\PBMessageSerializer.dll
copy protobuf-net.dll %projectPath%\protobuf-net.dll

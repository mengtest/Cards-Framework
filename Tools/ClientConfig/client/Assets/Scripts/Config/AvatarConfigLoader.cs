...
{
    private AvatarConfigLoader()
    {
        m_configCache = new List<AvatarConfig>();
//        m_configHashCache = new Hashtable();
    }

    private static AvatarConfigLoader m_instance = null;

    private List<AvatarConfig> m_configCache = null;

//    private Hashtable m_configHashCache = null;

    public static AvatarConfigLoader getInstance()
    {
        if (null == m_instance)
        {
            m_instance = new AvatarConfigLoader();
        }
    ...
    public void load(string path)
    {
        ...
        while (offset <= byteAll.Length)
        {
            ...
            AvatarConfig config = Serializer.Deserialize<AvatarConfig>(memStream);
...
//            m_configHashCache.Add(config.id, config);
 ...
 /*   public AvatarConfig getConfigByKey(object key)
    {
        ...
        return (AvatarConfig)m_configHashCache[key];
    }
*/
	public List<AvatarConfig> getAllCachedConfig()
	{

...
{
    private RoleConfigLoader()
    {
        m_configCache = new List<RoleConfig>();
//        m_configHashCache = new Hashtable();
    }

    private static RoleConfigLoader m_instance = null;

    private List<RoleConfig> m_configCache = null;

//    private Hashtable m_configHashCache = null;

    public static RoleConfigLoader getInstance()
    {
        if (null == m_instance)
        {
            m_instance = new RoleConfigLoader();
        }
    ...
    public void load(string path)
    {
        ...
        while (offset <= byteAll.Length)
        {
            ...
            RoleConfig config = Serializer.Deserialize<RoleConfig>(memStream);
...
//            m_configHashCache.Add(config.id, config);
 ...
 /*   public RoleConfig getConfigByKey(object key)
    {
        ...
        return (RoleConfig)m_configHashCache[key];
    }
*/
	public List<RoleConfig> getAllCachedConfig()
	{

...
{
    private DiamondConfigLoader()
    {
        m_configCache = new List<DiamondConfig>();
//        m_configHashCache = new Hashtable();
    }

    private static DiamondConfigLoader m_instance = null;

    private List<DiamondConfig> m_configCache = null;

//    private Hashtable m_configHashCache = null;

    public static DiamondConfigLoader getInstance()
    {
        if (null == m_instance)
        {
            m_instance = new DiamondConfigLoader();
        }
    ...
    public void load(string path)
    {
        ...
        while (offset <= byteAll.Length)
        {
            ...
            DiamondConfig config = Serializer.Deserialize<DiamondConfig>(memStream);
...
//            m_configHashCache.Add(config.id, config);
 ...
 /*   public DiamondConfig getConfigByKey(object key)
    {
        ...
        return (DiamondConfig)m_configHashCache[key];
    }
*/
	public List<DiamondConfig> getAllCachedConfig()
	{

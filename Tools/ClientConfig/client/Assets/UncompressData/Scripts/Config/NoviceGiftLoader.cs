...
class NoviceGiftLoader
{
    private NoviceGiftLoader()
    {
        m_configCache = new List<NoviceGift>();
//        m_configHashCache = new Hashtable();
    }

    private static NoviceGiftLoader m_instance = null;

    private List<NoviceGift> m_configCache = null;

//    private Hashtable m_configHashCache = null;

    public static NoviceGiftLoader getInstance()
    {
        if (null == m_instance)
        {
            m_instance = new NoviceGiftLoader();
        }
    ...
    public void load(string path)
    {
        ...
        while (offset <= byteAll.Length)
        {
            ...
            NoviceGift config = Serializer.Deserialize<NoviceGift>(memStream);
...
//            m_configHashCache.Add(config.Day, config);
 ...
 /*   public NoviceGift getConfigByKey(object key)
    {
        ...
        return (NoviceGift)m_configHashCache[key];
    }
*/
	public List<NoviceGift> getAllCachedConfig()
	{
